...
for m in m_values:
    for alpha in alpha_values:
        for f in f_values:
            ...
            try:
                command = f"python3 main_dist.py --dataset mnist --heterogeneity homogeneous --n 20 --m {m} --m_list {','.join(map(str,m_list))} --f {f} --T 100 --model cnn --lr 0.05 --attack SF --batch_size {m} --alpha {alpha} --nb_main_client 1 --nb_run 5 --nb_classes 10 --algo IPGDW"
